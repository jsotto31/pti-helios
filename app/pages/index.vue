      ...
      <v-col cols="4">
        <v-card class="rounded-lg pa-5 pt-0 mb-5" flat>
          ...
          <v-card flat color="primary" class="pa-8 rounded-lg">
            <v-sparkline :model-value="[5, 12, 38, 25, 130, 40, 50, 60]" auto-draw color="rgb(255,255,255)" height="50"
              padding="40" stroke-linecap="round" line-width="2" smooth></v-sparkline>
          </v-card>
        </v-card>
